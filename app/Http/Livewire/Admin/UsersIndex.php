...
{
    use WithPagination;
    public $search /* = "Hola compadre" */;/*  esto es para crear un buscador dinamico en la tabla de usuarios, video 21 03 de como crear un blog autoadmistrable de victor arana flores */
